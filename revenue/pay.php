    ...
    <div class="page-container">
                            ...
                            <div id="app">
                                <form>
                                    <div class="form-group">
                                        <label for="simpleFormEmail">Plot number</label>
                                        <input type="text" class="form-control" id="simpleFormEmail" placeholder="Enter plot number" v-model="landNo">
                                    </div>
                                    ...
                                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Pay</button>
                                    <div class="row">
                                        <div class="col">
                                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                <div class="card card-body">
                                                    ...
                                                    <div>
                                                        <button v-on:click="payForLand" class="btn btn-primary" type="button"
        ...
        <div class="page-footer" style="">
            <div class="page-footer-inner"> 2018 &copy;RevenueSure
                <a href="mailto:info@nouveta.co.ke" target="_top" class="makerCss">RevenueSure</a>
            </div>
        ...
        methods: {
            payForLand: function () {
                ...
                axios.post(url, formData).then(response=>{
                    ...
                    if(!alert('Check your phone to complete the payments!')){window.location.reload();}
