                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">New Business Permit </div>
                            </div>
                                ...
                                <div>
                                    <form>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="simpleFormEmail" placeholder="Enter business ID" v-model="businessNo">
                                        </div>
                                        <div class="form-group">
                                            <label for="simpleFormPassword">Renew permit for the year...</label>
                                            <input type="text" class="form-control" id="simpleFormPassword" placeholder="year" v-model="year">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <p>
                                            ...
                                            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Card</button>
                                        </p>
                                        <div class="row">
                                            <div class="col">
                                                <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                    <div class="card card-body">
                                                        ...
                                                        <div>
                                                            <button v-on:click="newBusinessPermit" class="btn btn-primary" type="button"
            ...
            newBusinessPermit: function () {
                ...
                axios.post(url, formData).then(response=>{
                    ...
                    if(
                        ...
                        !alert('Check your phone to complete the payments!')){window.location.reload();}
