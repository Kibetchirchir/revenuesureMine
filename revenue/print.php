                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Print Parking Receipt </div>
                            </div>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
                                          <div class="form-group row">
                                              <label class="control-label col-md-3">Select Parking type
                                              ...
                                              <div class="col-md-4">
                                                  <select class="form-control" name="select">
                                                      ...
                                                      <option value="Category 2">Seasonal</option>
                                          ...
                                          <div class="form-group row">
                                              <label class="control-label col-md-3">Date Picking</label>
                                      ...
                                      <div class="form-group">
                                            <div class="offset-md-3 col-md-9">
                                                <button type="submit" class="btn btn-info">Print Receipt</button>
