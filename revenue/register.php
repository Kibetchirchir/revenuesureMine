                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Business Permit Registration </div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                                </li>
                                <li class="active">Renew Business Registration</li>
                            </ol>
                        </div>
                    </div>
                                ...
                                <div class="card-body" id="bar-parent1">
                                    <form action="#" id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">ID Document Type
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <select class="form-control" name="select">
                                                        <option value="">Select...</option>
                                                        <option value="Category 1">National ID Card</option>
                                                        <option value="Category 2">Kenyan Passport</option>
                                                        <option value="Category 3">Driving License</option>
                                                        <option value="Category 4">Passport (Non Kenyan)</option>
                                                        <option value="Category 5">Registration Certificate</option>
                                                        <option value="Category 6">Other Document</option>
                                                    </select>
                                                </div>
                                            </div>

                                            <div class="form-group row">
                                                <label class="control-label col-md-3">ID Document Number
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">KRA Pin Number
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">VAT Number
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
