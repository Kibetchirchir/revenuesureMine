            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">Seasonal Parking Payment </div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                            </li>
                            <li class="active">Seasonal Parking</li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Select Duration
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control" name="select">
                                                        ...
                                                        <option value="Category 5">Motorbike</option>
                                                        <option value="Category 6">Excavators</option>
                                                    </select>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col">
                                                        <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                            <div class="card card-body">
                                                                ...
                                                                <div>
                                                                    <button @click="parkingMonthly" class="btn btn-primary" type="button"
...
<script src="assets/js/theme-color.js" ></script>v
<!-- Material -->
...
<script>
    ...
    var app = new Vue({
        ...
        methods: {
            parkingMonthly: function () {

                var app = this
                var formData = new FormData;
                url = 'http://localhost/rcounty/api/index.php'
                formData.append('function', 'ParkingMonthly');
