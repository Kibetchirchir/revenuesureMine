            ...
            <div class="page-content">
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        <div class=" pull-left">
                            <div class="page-title">House Rent </div>
                        </div>
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            <li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
                            </li>
                            <li class="active">House rent</li>
                        </ol>
                    </div>
                </div>
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal">
                                        <div class="form-body">
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Market
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Market/Stall Type
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <select class="form-control" name="select">
                                            ...
                                            <div class="form-group row">
                                                <label class="control-label col-md-3">Stall Number
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" name="select" v-model="structureNo">
                                                    ...
                                                    <div class="col">
                                                        <div class="collapse multi-collapse" id="multiCollapseExample1">
                                                            <div class="card card-body">
                                                                ...
                                                                <div>
                                                                    <button @click="payForMarket" class="btn btn-primary" type="button"
...
<script>
    ...
    var app = new Vue({
        ...
        methods: {
            payForMarket: function () {

                var app = this
                var formData = new FormData;
                url = 'http://localhost/rcounty/api/index.php'
                formData.append('function', 'PayingmarketRent');
                formData.append('StructureNo', app.structureNo);
